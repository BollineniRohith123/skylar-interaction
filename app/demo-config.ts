...
function getSystemPrompt() {
  ...
  ## Available Images
    - pumpkin-spice-donut.jpg: Pumpkin Spice Donut
    - chocolate-donut.jpg: Chocolate Donut
    - blueberry-donut.jpg: Blueberry Donut
    - coffee.jpg: Regular Coffee
  ...
  ## New Tool Usage
  - You must call the tool "showImage" when the user asks to see a picture or image of a menu item.
  - Provide the exact image filename from the list above.
  ...
  1. Menu Mismatches
    ...
    - Offer to show the item image if available
  2. Unclear Input
...
const selectedTools: SelectedTool[] = [
  ...
  },
  {
    "temporaryTool": {
      ...
      "description": "Display an image of a menu item on the screen when the user asks to see a picture.",
      "dynamicParameters": [
        {
          "name": "imageName",
          "location": ParameterLocation.BODY,
