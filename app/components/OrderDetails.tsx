...
const OrderDetails: React.FC = () => {
  ...
  return (
    <div className="mt-10">
      <h1 className="text-2xl font-bold mb-6 text-gradient-sky">Campaign Builder</h1>

      {/* Sidebar Summary - Basic Details */}
      {campaignStrategy && (
        <div className="mb-6">
          {/* Basic Campaign Info for Sidebar */}
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-600 rounded-lg p-5 shadow-lg">
            <h3 className="text-xl font-bold text-gradient-sunset mb-4">Campaign Summary</h3>

            <div className="space-y-3 text-sm">
              <div className="flex justify-between items-center p-2 bg-gray-800/50 rounded">
                <span className="text-gray-300">Campaign Goal:</span>
                <span className="text-white font-semibold">{campaignStrategy.campaignGoal}</span>
              </div>
              ...
              <div className="flex justify-between items-center p-2 bg-gray-800/50 rounded">
                ...
                <span className="text-gradient-gold font-bold text-lg">{formatINR(campaignStrategy.totalBudget)}</span>
              </div>

              <div className="flex justify-between items-center p-2 bg-gray-800/50 rounded">
                <span className="text-gray-300">Target Audience:</span>
                <span className="text-white font-semibold">{campaignStrategy.targetAudience}</span>
              </div>

              <div className="border-t border-gray-600 pt-3 mt-3 space-y-2">
                <div className="flex justify-between items-center p-2 bg-blue-900/20 rounded border border-blue-800/30">
                ...
                <div className="flex justify-between items-center p-2 bg-cyan-900/20 rounded border border-cyan-800/30">
                ...
                <div className="flex justify-between items-center p-2 bg-yellow-900/20 rounded border border-yellow-800/30">
                  ...
                  <span className="text-gradient-gold font-bold text-lg">{campaignStrategy.impact.expectedROI}%</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {!campaignStrategy && orderDetails.items.length === 0 && (
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 border-2 border-dashed border-gray-600 rounded-lg p-8 text-center shadow-lg">
          <div className="flex flex-col items-center justify-center gap-4">
            <div className="bg-gradient-to-br from-blue-600 to-indigo-600 rounded-full p-5 shadow-lg">
              <svg className="w-14 h-14 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
              </svg>
            </div>
            <div>
              <h3 className="text-2xl font-bold text-gradient-sunset mb-3">Ready to Build Your Campaign?</h3>
              <p className="text-gray-300 text-lg mb-2">Start a call and tell us about your brand awareness goals and budget.</p>
              <p className="text-gray-400 text-sm mt-3 italic">Example: "I need a branding campaign for 5 lakh rupees to increase brand awareness"</p>
            </div>
          </div>
        </div>
      )}
